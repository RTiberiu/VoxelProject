...
struct Z_CompiledInDeferFile_FID_Users_rociu_Documents_Unreal_Projects_UnrealTest_Source_UnrealTest_Private_CustomChunk_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACustomChunk, ACustomChunk::StaticClass, TEXT("ACustomChunk"), &Z_Registration_Info_UClass_ACustomChunk, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACustomChunk), 960303869U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_rociu_Documents_Unreal_Projects_UnrealTest_Source_UnrealTest_Private_CustomChunk_h_4268615224(TEXT("/Script/UnrealTest"),
