...
private:
	...
	const TMap<StatsType, FVector> StatsVoxelOffsets = {
		...
		{StatsType::Notification, FVector(50.0f, -25.0f, 200.0f)} // Use (50.0f, -50.0f, 250.0f) if AlliesInPack is implemented
	};
	...
	{5, {FColor(68,68,68), FColor(16, 0, 118), FColor(78,176,19), FColor(196,35,35)}}
	};
