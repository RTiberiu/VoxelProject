...
class SearchProblem {
protected:
    VoxelSearchState* startState; // the initial state
    int nodeVisited;
...
public:
    /**
        ...
        */
    SearchProblem(VoxelSearchState* start) : startState(start), nodeVisited(0) {}
    ...
    virtual bool isGoal(VoxelSearchState* state) const = 0;
